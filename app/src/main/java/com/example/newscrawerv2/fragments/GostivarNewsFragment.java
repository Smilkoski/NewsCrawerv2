...
public class GostivarNewsFragment extends Fragment implements CustomListAdapter.OnArticleListener {
    ...
    private static Article scanGostivarPress(Document doc) {
        try {
            String title = doc.title().replace(" | Gostivarpress.mk", "");
            ...
            String imgSrc = doc.getElementById("mvp-post-feat-img")
                    .select("img")
                    .attr("src");
    ...
    public void generateAllArticles() {
        ...
        List<String> urls = Arrays.asList(
                "https://gostivarpress.mk/category/vesti/gostivar/",
                "https://gostivarpress.mk/category/vesti/gostivar/page/2/"
        );
    ...
    private static class ScanArticleTask extends AsyncTask<String, Void, Article> {
        ...
        protected Article doInBackground(String... urls) {
            try {
                ...
                return scanGostivarPress(document);
